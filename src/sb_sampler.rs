...
/// Backend identity for `quip-cpu-hbsb` (heated ballistic Simulated
/// Bifurcation: continuous coupling, gamma 0.5). Experimental track. This is
/// the strongest heating of the four variants, so it is the one the wall
